...
const Search = ({ active }: Status) => {
  ...
  return (
    <div
      ...
      className='fixed top-0 left-0 h-full w-full right-0 overflow-y-hidden bg-[rgba(252,252,252,0.24)] bg-scroll bg-clip-padding backdrop-filter backdrop-blur-[150px] backdrop-contrast-100 saturate-[1.8] '
    >
